            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('product_category.update', $productCategory->category_id) }}" class="mt-3">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="category_name" type="text"
                                        ...
                                        value="{{$productCategory->category_name}}" autocomplete="name" autofocus>
